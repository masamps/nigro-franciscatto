...
const Team = () => {
  const team = [
    {
      ...
      image: lawyer1,
      description:
        "Especialista em direito securitário com mais de 18 anos de experiência. Mestre em Direito Civil pela USP e pós-graduada em Direito do Consumidor. Reconhecida pelo mercado por sua atuação em casos complexos de seguros de vida e previdência.",
      education: [
      ...
      email: ["robertanigro@nigrofranciscatto.com.br"],
      whatsapp: [],
    },
    {
      ...
      image: lawyer2,
      description:
        "Advogado especializado em litígios securitários e recursos administrativos com 15 anos de experiência. Pós-graduado em Direito do Seguro pela ENS e especialista em mediação e arbitragem. Reconhecido por sua expertise em casos de sinistros complexos.",
      education: [
        "Graduação em Direito 2022 - Faculdade de Direito de Sorocaba - FADI",
      ],
      achievements: ["OAB 521.116"],
      email: ["nicolefranciscatto@nigrofranciscatto.com.br"],
      whatsapp: [],
    },
    {
      ...
      achievements: ["OAB 262.791"],
      email: ["robertacarvalho@nigrofranciscatto.com.br"],
      whatsapp: [],
    },
  ];
  ...
  return (
    <>
      <Helmet>
        <title>
          Nossa Equipe | Advocacia em Seguros - Profissionais Especializados
        </title>
        <meta
          name="description"
          content="Conheça nossa equipe de advogados especialistas em direito securitário. Profissionais qualificados com vasta experiência em seguros e litígios."
        />
        <meta
          name="keywords"
        ...
        <section className="py-section bg-background">
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
            ...
            <p className="font-sans text-lg md:text-xl text-muted-foreground max-w-4xl mx-auto leading-relaxed">
              ...
              excelência no atendimento e na defesa dos direitos de nossos
              clientes. Cada membro de nossa equipe traz experiência única em
              direito securitário.
            </p>
          </div>
        </section>
          ...
          <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
            <div className="text-center mb-12">
              ...
              <p className="font-sans text-lg text-muted-foreground leading-relaxed">
                Estamos sempre em busca de talentos excepcionais para integrar
                nosso time. Se você é um profissional apaixonado por direito
                securitário e busca um ambiente de trabalho estimulante e
                colaborativo, queremos conhecê-lo.
              </p>
            </div>
            ...
            <div className="bg-card p-8 rounded-lg shadow-sm border">
                ...
                <div>
                  ...
                  <ul className="space-y-3">
                    ...
                    <li className="flex items-start gap-3">
                      <div className="w-2 h-2 bg-primary rounded-full mt-2 flex-shrink-0"></div>
                      <span className="font-sans text-muted-foreground">
                        Participação em casos desafiadores
                      </span>
                    </li>
                    <li className="flex items-start gap-3">
                      <div className="w-2 h-2 bg-primary rounded-full mt-2 flex-shrink-0"></div>
                ...
                <div>
                  ...
                  <ul className="space-y-3">
                    <li className="flex items-start gap-3">
                      ...
                      <span className="font-sans text-muted-foreground">
                        Formação em Direito com excelência acadêmica
                      </span>
                    </li>
                    <li className="flex items-start gap-3">
                      <div className="w-2 h-2 bg-secondary rounded-full mt-2 flex-shrink-0"></div>
                      <span className="font-sans text-muted-foreground">
                        Interesse em direito securitário
                      </span>
                    </li>
                    <li className="flex items-start gap-3">
                      <div className="w-2 h-2 bg-secondary rounded-full mt-2 flex-shrink-0"></div>
              ...
              <div className="text-center mt-8 pt-8 border-t border-border">
                <p className="font-sans text-muted-foreground mb-6">
                  Interessado em fazer parte da nossa equipe? Envie seu
                  currículo e participe dos nossos processos seletivos.
                </p>
          ...
          <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
            ...
            <div className="flex flex-col sm:flex-row gap-4 justify-center">
              <Button variant="secondary" asChild>
                <Link to="/areas-atuacao">Ver Áreas de Atuação</Link>
              </Button>
              <Button
                className="border border-input  hover:bg-accent hover:text-accent-foreground"
                asChild
              >
                <Link to="/contato">Solicitar Consulta</Link>
              </Button>
            </div>
          </div>
        </section>
